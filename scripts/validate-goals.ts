...
const items = new Set([...ids('src/data/generated/v2/items.json'), ...ids('src/data/special_items.json'), ...ids('src/data/generated/v2/special_items.json'), ...ids('src/data/generated/items.json')]);
const guests = ids('src/data/generated/v2/guests.json');
const guidebooks = ids('src/data/generated/v2/guidebooks.json');
const recruits = new Set([...ids('src/data/recruit_tiers.json'), ...ids('src/data/generated/v2/recruit_tiers.json')]);
