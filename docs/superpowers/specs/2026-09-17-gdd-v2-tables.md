...
## 15. 원정 팝업·라이벌 (스펙 §15.2–15.3)
- 지역 7·이름 있는 손님 56은 v1 §5(`regions.json`·`named_guests.json`)를 그대로 쓴다. 이 절은 라이벌 카페 타입만 다룬다.

### 15.3 라이벌 (6)
- 3년차부터 월 10%로 생김(동시 최대 2, 월 최대 1). 매월 단골★ 1명을 뺏고(`뺏는 단골/월`) 우리 메뉴의 `양`·`보기`를 `스탯 감소`만큼 누적으로 깎는다(합 −50% 상한). 12개월 뒤 자진 철수.
- `카페 대결`(challenge): 심사 = Σ 가중치 × 메뉴 스탯 + 운 vs 라이벌 점수(규모 소 6·중 8·대 10 × (1 + (년차−1) × 0.1)). 이기면 철수·마일리지 2·단골 회수, 지면 인기 −5. 라이벌당 한 달에 한 번.
- `월 파산`: 대형은 유지비가 커서 매월 이 확률로 스스로 파산·철수한다.
| id | 이름 | 규모 | 유지비 | 뺏는 단골/월 | 스탯 감소 | 심사 가중치 | 월 파산 | 대사 |
|---|---|---|---|---|---|---|---|---|
| rv_local_cafe | 동네 카페 | 소 | 200,000 | 1 | 5% | 맛 0.5·향 0.3·제주 0.2 | 0% | 우리도 원두 바꿨수다 |
| rv_franchise | 프랜차이즈 | 대 | 1,500,000 | 1 | 5% | 맛 0.3·양 0.4·보기 0.3 | 15% | 전국 어디서나 같은 맛 |
| rv_truck_cafe | 트럭 카페 | 소 | 100,000 | 1 | 5% | 향 0.4·양 0.3·보기 0.3 | 0% | 오늘은 해변, 내일은 오름 |
| rv_dessert_shop | 디저트 전문 | 중 | 600,000 | 1 | 5% | 맛 0.4·보기 0.4·건강 0.2 | 0% | 케이크 한 조각의 예술 |
| rv_big_brand | 대형 브랜드 | 대 | 3,000,000 | 1 | 5% | 맛 0.2·향 0.2·보기 0.2·건강 0.2·양 0.2 | 15% | 제주 1호점 오픈! |
| rv_sns_cafe | SNS 카페 | 중 | 500,000 | 1 | 5% | 보기 0.5·제주 0.3·향 0.2 | 0% | 사진이 다 했지 |
