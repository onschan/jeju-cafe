...
### 10.3 마일리지 상점 (14)
- 마일리지 획득: 부탁 완료 1, 가이드북 1위 2~5, 도감 10개마다 1, 희귀 손님 만족 2, 유명 셰프 암행 성공 3.
| id | 품목 | 가격 | 설명 |
|---|---|---|---|
| ms_worker_3 | 일꾼 삼춘 고용(3번째) | 30 | 동시에 지을 수 있는 시설 +1 |
| ms_worker_4 | 일꾼 삼춘 고용(4번째) | 81 | 동시에 지을 수 있는 시설 +1 |
| ms_worker_5 | 일꾼 삼춘 고용(5번째) | 138 | 동시에 지을 수 있는 시설 +1 |
| ms_pickaxe | 돌담 철거 곡괭이 | 5 | 부지에 원래 있던 돌담을 1칸 없애요 |
| ms_ticket | 응모권 | 3 | 응모권 추첨 1회 |
| ms_tangerine_seed | 감귤 씨앗 | 8 | 시설 인기 +5 |
| ms_hallabong_seed | 한라봉 씨앗 | 8 | 시설 요금 +5% |
| ms_seed_pack | 씨앗 5개 묶음팩 | 35 | 감귤 씨앗 3 + 한라봉 씨앗 2 |
| ms_jeju_tea_set | 제주 차 세트 | 6 | 강화 아이템 |
| ms_comic_book | 만화책 | 4 | 강화 아이템 |
| ms_glasses | 안경 | 4 | 강화 아이템 |
| ms_tv | TV | 10 | 강화 아이템 |
| ms_jeju_salt | 제주 소금 | 5 | 강화 아이템 |
| ms_scout | 직원 스카우트권 | 12 | 다음 채용 비용 무료 |
