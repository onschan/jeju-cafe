...
import { guestFace, unlockedTypeIds, walletOf } from '../sim/index.ts';
import { guestTypeDef, GUEST_TYPES } from '../data/index.ts';
import { BoardPanel } from './BoardPanel';
import { Portrait, guestPortraitParts, guestName } from './GuestPopup';
import { Bar } from './StaffPanel';
import { card, brownBtn, brownBtnOn, PALETTE, won } from './frame';

type Sub = 'now' | 'quests' | 'codex';
const SUBS: { id: Sub; label: string }[] = [{ id: 'now', label: '지금 온 손님' }, { id: 'quests', label: '부탁' }, { id: 'codex', label: '손님 도감' }];
