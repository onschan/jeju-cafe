...
import { useTutorial, currentStep, checkTutorial, advanceTutorial, skipTutorial, TUTORIAL_STEPS } from './tutorial';
...
export function TutorialOverlay() {
  ...
  return (
    <div data-testid="tutorial" data-step={step.id} style={{ position: 'absolute', top: GUIDE_TOP, left: 12, right: 12, display: 'flex', alignItems: 'flex-start', gap: 8, pointerEvents: 'none' }}>
      <style>{PULSE_CSS}{step.tab ? `[data-tab="${step.tab}"] { animation: tut-pulse 1s ease-in-out infinite; }` : ''}</style>
