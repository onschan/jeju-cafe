...
export const TUTORIAL_STEPS: TutorialStep[] = [
  { id: 1, tab: '메뉴판', lines: ['어서 오라. 카페는 메뉴가 먼저다.', '메뉴판 탭에서 아메리카노를 올려 보라.'],
  ...
  { id: 7, tab: '보기', lines: ['밭에 당근을 심고, 반짝이면 눌러 수확하라.', '보기 탭에서 밭을 누르면 심기·수확이 나온다.'],
    done: (s) => acted(s, 'harvest') || Object.values(s.storage).some((n) => n > 0) },
  { id: 8, tab: '홍보', lines: ['손님이 적으면 알려야지.', '홍보 탭에서 전단이라도 돌려 보라.'],
