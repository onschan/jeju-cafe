...
const btn: CSSProperties = { width: 32, height: 44, padding: 0, border: `2px solid ${PALETTE.wood}`, borderRadius: 6, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: PALETTE.btn };
