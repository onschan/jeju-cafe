...
export function createInitialState(seed: number, playerId = 'local', createdAt = 0, layout: StartLayout = 'starter', carry: CarryOver | null = null): GameState {
  ...
  const state: GameState = {
    ...
    battle: initBattle(), // 동네 대항전 전적 (2년차부터)
    activeSkills: {},     // 러시 액티브 스킬 쿨다운
    activeSkillSlots: 1,  // 스킬 칸 1개 (2번째는 러시 등급 누적 해금 + 러시 연수)
    titleChanceBonus: 0,
    luckSeq: 0,
    monthGreatServes: 0,
    main: initMain(),
