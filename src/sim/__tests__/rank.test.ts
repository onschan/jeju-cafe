...
test('★ 조건 문구 해석: 월 매출·메뉴·직원·손님층 만족·시그니처·랜드마크·랭킹 1위·도감%·정착 등급, 모르는 문구는 false', () => {
  ...
  s.staff.push({ id: 's1', name: 'a', face: { hair: 0, skin: 0, top: 0 }, stats: { service: 50, cooking: 10, sense: 10, stamina: 10 }, skill: 'none', level: 1, salary: 0, role: 'hall', unpaidMonths: 0, energy: 100, lastParttimeMonthIndex: -1, x: 0, y: 0, path: [], anchor: null, waitMs: 0 });
...
test('심사 점수는 모두 0~100이고 같은 상태면 같은 값(결정적), 직원·좌석이 생기면 미소·경관이 오른다', () => {
  ...
  s.staff.push({ id: 's1', name: 'a', face: { hair: 0, skin: 0, top: 0 }, stats: { service: 80, cooking: 10, sense: 10, stamina: 10 }, skill: 'none', level: 1, salary: 0, role: 'hall', unpaidMonths: 0, energy: 100, lastParttimeMonthIndex: -1, x: 0, y: 0, path: [], anchor: null, waitMs: 0 });
  placeObject(s, 'table_out', X(6), Y(4));
...
test('발표: 3·9월에 해금된 가이드북을 채점해 순위·상금·연구·마일리지·씨앗(1위), best 갱신, lastAnnouncement', () => {
  ...
  s.staff.push({ id: 's1', name: 'a', face: { hair: 0, skin: 0, top: 0 }, stats: { service: 99, cooking: 99, sense: 99, stamina: 99 }, skill: 'none', level: 1, salary: 0, role: 'hall', unpaidMonths: 0, energy: 100, lastParttimeMonthIndex: -1, x: 0, y: 0, path: [], anchor: null, waitMs: 0 });
