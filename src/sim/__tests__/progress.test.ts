...
test('연구 진행: 만족 손님 5명 = 연구 1, 연구원 스킬(+50%)이면 더 빨리', () => {
  ...
  s.staff.push({ id: 's1', name: 'a', face: { hair: 0, skin: 0, top: 0 }, stats: { service: 1, cooking: 1, sense: 1, stamina: 1 }, skill: 'researcher', level: 1, salary: 0, role: 'hall', unpaidMonths: 0, energy: 100, lastParttimeMonthIndex: -1, x: 0, y: 0, path: [], anchor: null, waitMs: 0 });
