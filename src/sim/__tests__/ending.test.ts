...
describe('최종 점수', () => {
  test('항목 9·가중치·상한·칭호 5단계', () => {
    ...
    s.codex.corners = ['a', 'b', 'c']; s.spots = { x: 5, y: 3 }; // fun-corner: 콤보 도감 → 테마 도감(24종, 상한 24)
...
describe('이월', () => {
  test('makeCarry: 테마 도감·명소 Lv·유니폼·돌하르방(최대 2)·응모권 20%·손님 인기 20%', () => {
    const s = bareState(4);
