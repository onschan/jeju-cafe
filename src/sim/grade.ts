 ...
 * 조건 = 누적 손님·명당 수·평판·★ 네 가지를 모두 채우면 승급 (내려가지 않는다). 랭크(rank.ts)·★(guidebook.ts)와 달리
...
/** 등급 g가 되려면 (누적 손님·명당·평판·★) 전부 ≥ GRADE_REQS[g] */
...
/** 완성한 명당 수 — 트랙 C completedCorners(지금 마당에 완성돼 있는 명당). */
