...
export { CHAPTERS, CHAPTER_TICKETS, chapterProgress, currentChapter, chaptersCleared, allChaptersDone, countsForChapter, checkChapter, chapterLine, chapterBlocker, chapterResultLine, chapterHits, chapterGrades, type ChapterDef } from './chapter.ts'; // chapter: 한 판 = 다섯 막
