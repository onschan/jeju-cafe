...
export { CHAPTERS, CHAPTER_MONEY, chapterProgress, currentChapter, chaptersCleared, allChaptersDone, noteChapterSeat, checkChapter, chapterLine, chapterBlocker, chapterHits, type ChapterDef } from './chapter.ts'; // chapter: 한 판 = 다섯 막
