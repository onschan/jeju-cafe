...
export { CHAPTERS, CHAPTER_TICKETS, chapterProgress, currentChapter, chaptersCleared, allChaptersDone, countsForChapter, checkChapter, chapterLine, chapterResultLine, type ChapterDef } from './chapter.ts'; // chapter: 한 판 = 다섯 막
