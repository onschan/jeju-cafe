...
export { STEPS as TUTORIAL_STEP_DEFS, TUTORIAL_STEPS, TUTORIAL_ACTS, tutorialActDef, actOpen, actDone, actsDone, currentAct, nextTutorialStep, waitingForAct, stepGapPassed, actOfStep, currentTutorialStep, tutorialStepReady, stepTargets, tutorialStepDone, tutorialDone, dialogueSeen, pathConnected, recommendedMainCells, cornerMade, cornerMissingType, cornerMissingKind, cornerCells, firstSale, LOOK_TEXT, TUTORIAL_STEP_GAP_DAYS, type TutorialStepDef, type TutorialActDef, type TutorialNoteKey, type LookId } from './tutorial.ts';
...
export { canDrawTicket, canSetUniform, canUseGuestItem, hasFreeDraw, hasUniform, rollPrize, drawPreview, SEED_PACK, DRAW_MONEY_PER_YEAR, UNIFORM_PIECES_PER_SET, MONTHLY_FREE_TICKETS, type DrawPreviewRow } from './shop.ts';
export { addTickets, codexCount, checkCodexTickets, monthlyTickets, CODEX_PER_TICKET, GUESTS_PER_TICKET, TICKET_HINT } from './mileage.ts';
...
export { WANT_LABEL, WANT_ICON, wantOf, wantLine, seatFitsWant, seatFitsGuest, FIT_VIEW, FIT_RADIUS, type Want } from './wants.ts'; // 카이로 방향: 손님이 보는 것과 「그 자리가 맞나」
