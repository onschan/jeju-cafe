 ...
 *  인사(greetGuest)는 rush-battle §3에서 사라졌다 — 손님과의 상호작용은 러시 중 자리 배정·주문 처리다. */
export const TRACKED_ACTIONS: ReadonlySet<string> = new Set<string>([
  'undoLast', 'train', 'develop', 'drawTicket', 'buyMileage', 'buyTicket', 'giveGift', 'respondEvent', 'investSpot',
