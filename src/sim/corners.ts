/**
 * 코너 (fun-reset 스펙 §3, fun-corner): 서로 다른 시설 3~4종이 반경 2 안에 모이면 이름 있는 코너가 된다.
 *
...
/** 이 코너의 닻 후보 중 처음 완성되는 것 (오브젝트 등록 순 — 결정적) */
...
/** 지금 완성된 코너 목록 (코너당 최대 1개). 배치가 바뀔 때만 다시 센다. */
...
// ---------- 효과 훅 ----------
/** 시설 하나가 받는 코너 인기·요금 (반경 안 완성 코너 합산, 상한) — compat.rawStats 훅 */
